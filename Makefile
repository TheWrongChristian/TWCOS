...
QEMU_OPTS=-d cpu_reset,guest_errors -serial stdio -hda $(TEST_FAT) -drive if=none,id=stick,file=$(INITRD_TAR) -usb -device usb-storage,drive=stick -device usb-ehci,id=ehci
