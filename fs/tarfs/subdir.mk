...
TARFS_FILES := user/shell/init user/picol/picol user/picol/script.tcl
INITRD_TAR := $(subdir)/tarfs.tar
...
$(INITRD_TAR): $(TARFS_FILES)
	tar -cf $(INITRD_TAR) $(TARFS_FILES) $(TARFS_DEEPDIR)
